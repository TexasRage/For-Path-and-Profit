...
Characters may purchase any Specialization from any career. The cost to purchase a new Specialization depends on whether it is within the character’s career or outside it.

Purchasing an additional career Specialization costs 10 × the total number of Specializations the character would possess after gaining it. For example, a character with one Specialization may purchase a second for 20 XP; a third would cost 30 XP.

Purchasing a non-career Specialization costs 10 × the total number of Specializations the character would possess after gaining it, plus an additional 10 XP. For example, a character with one Specialization may purchase a second non-career Specialization for 30 XP; if they already have two Specializations, a third non-career Specialization would cost 40 XP.

All Specializations are purchased using experience points (XP), which may be spent during character creation or later advancement as normal.
